    ...
    public class UIController : MonoBehaviour
    {
       ...
       [Header("Infos")]
        ...
        public void Logout()
        {
            ...
            useVIPNFT.interactable = true;
            playGameBtn.interactable = true;

            buy1000GoldBtn.gameObject.SetActive(true);
            buy5000GoldBtn.gameObject.SetActive(true);
            buy10000GoldBtn.gameObject.SetActive(true);
            buy100GemBtn.gameObject.SetActive(true);
            buyVIPNFT.gameObject.SetActive(true);
            useVIPNFT.gameObject.SetActive(true);
            playGameBtn.gameObject.SetActive(true);

            BuyingStatusText.gameObject.SetActive(false);
            VIPNFTStatusText.gameObject.SetActive(false);

            ResourceBoost.Instance.goldBoost = 0;
            ResourceBoost.Instance.gemBoost = 0;
            ResourceBoost.Instance.boostValue = 1;

            playerGoldText.text = "Current Gold: 0";
            playerGemText.text = "Current Gem: 0";
            userVIPNFTBalance.text = "VIP NFT: 0";
        }
        ...
        public void BuyItems(int itemNo)
        {
            StartCoroutine(AptosUILink.Instance.BuyPowerUp(itemNo));
        }

        public void BuyVIPNFT()
        {
            StartCoroutine(AptosUILink.Instance.BuyVIPNFT());
        }

        public void UseVIPNFT()
        {
            StartCoroutine(AptosUILink.Instance.UseVIPNFT());
        }
